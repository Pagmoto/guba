...
OWNER_ID = environ.get('OWNER_ID', '855828909')
if len(OWNER_ID) == 0:
...
TELEGRAM_API = environ.get('TELEGRAM_API', '15954453')
...
TELEGRAM_HASH = environ.get('TELEGRAM_HASH', '3470b59401b79efbd00a846cb12675fb')
